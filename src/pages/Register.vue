                ...
                <div
                    ...
                    <form class="space-y-6" @submit.prevent="handleLogin">
                        <div class="mb-12">
                            ...
                            <p class="text-slate-500 text-sm mt-6 leading-relaxed">Sign in to your account and explore a
                        ...
                        <div>
                            <label class="text-slate-800 text-sm font-medium mb-2 block">Email Address</label>
                            <div class="relative flex items-center">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb"
                                    class="w-[18px] h-[18px] absolute right-4" viewBox="0 0 24 24">
                                    <path d="M20 4H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 2v.511l-8 5.33-8-5.33V6h16zM4 18v-9.191l8 5.33 8-5.33V18H4z"></path>
                                </svg>
                            </div>
                        </div>
                        ...
                        <div class="!mt-12">
                            ...
                            <p class="text-sm !mt-6 text-center text-slate-500">Already have an account <a
